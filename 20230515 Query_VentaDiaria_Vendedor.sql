...
select d1.SubEntidad,d1.f0nfchfct,d1.e2nempl,d1.v0nemplnmb,d1.l2ncln,d1.v0nclnnmb,d1.ValorDiv,d1.EquivDiv,
...
left join (select distinct e1neno,e2nempl,v0nemplnmb from bpcempl where c0nbndact='S') emp on emp.e2nempl=fct.l0nvnd and emp.e1neno=fct.e0nenovnd
...
where fct.f0nfchfct>='01-01-2023' group by sse.cDescSSEnt,fct.f0nfchfct,emp.e2nempl,emp.v0nemplnmb,cl.l2ncln,cl.v0nclnnmb) d1
...
group by d1.SubEntidad,d1.f0nfchfct,d1.e2nempl,d1.v0nemplnmb,d1.l2ncln,d1.v0nclnnmb,d1.ValorDiv,d1.EquivDiv,d1.MontoBruto,d1.MB,d1.MBP,d1.MBF
--NOTAS DE CRÉDITO
union all
select distinct sse.cDescSSEnt SubEntidad,--548
ntne.f0nfchntc,ntne.l0nvnd e2nempl,ep.v0nemplnmb v0nemplnmb,ntne.l0ncln l2ncln,cl.v0nclnnmb,redvs.d0neqv 'ValorDiv',ntne.d0neqvdvs 'EquivDiv','MB'=0,'MBP'=0,'MBF'=0,'M_DV'=0,'MB_DV'=0,'MBF_DV'=0,'MBP_DV'=0,ntne.d0nmntbrt 'M_NC',
isnull((case 
...
from (select nt1.e0nenocln,nt1.f0nfchntc,nt1.e0ndvs,nt1.l0ncln,nt1.e0nenovnd,nt1.l0nvnd,nt1.d0neqvdvs,nt1.d0nmntbrt,nt1.d0nmntdop,nt1.d0nmntdopp from (select ft.f0nfchfct,ft.e0nenoeor,ft.l0neor,sum(ft.d0nmntbrt) d0nmntbrt from bpmfct ft group by ft.f0nfchfct,ft.e0nenoeor,ft.l0neor) ft1
right join (select nt.e0nenocln,nt.f0nfchntc,nt.l0ncln,nt.e0nenovnd,nt.l0nvnd,avg(nt.e0ndvs) e0ndvs,avg(nt.d0neqvdvs) d0neqvdvs,sum(nt.d0nmntafc) d0nmntbrt,sum(nt.d0nmntdop) d0nmntdop,sum(nt.d0nmntdopp) d0nmntdopp 
from bpmntc nt where nt.e0nenocln=1 and nt.c0nbndact='S' and cBndAutCxc='S' and cBndAutGte='S' group by nt.e0nenocln,nt.f0nfchntc,nt.l0ncln,nt.e0nenovnd,nt.l0nvnd) nt1
on ft1.f0nfchfct=nt1.f0nfchntc and ft1.l0neor=nt1.l0ncln and nt1.e0nenocln=ft1.e0nenoeor where ft1.f0nfchfct is null) ntne --nt1.l0ncln=168 and
...
left join (select distinct e1neno,e2nempl,v0nemplnmb from bpcempl where c0nbndact='S') ep on ep.e1neno=ntne.e0nenovnd and ep.e2nempl=ntne.l0nvnd
